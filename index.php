                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Best for: Property management, accounting, and tenant communication.
Features:
    Tenant and lease tracking, Maintenance management, Mobile access
 User-friendly, great for both residential and commercial properties..</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>A high-quality system will regularly update to fix bugs, add new features, and respond to customer feedback..</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>TTo find an experienced agent for a real estate management system, look for professionals with a deep understanding of property management workflows and systems</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>N"A visionary development designed to blend modern living with sustainable features, offering luxurious spaces and unparalleled amenities for the discerning resident."

"This innovative real estate project redefines urban living with its prime location, cutting-edge design, and exceptional quality, creating a lasting impact on the community.".</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
